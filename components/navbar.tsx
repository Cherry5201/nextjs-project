    ...
    <header className="sticky top-0 z-50 border-b border-orange-100 bg-white/90 backdrop-blur-md">
      <nav className="flex w-full items-center justify-between px-6 py-4">
        ...
        <div className="flex gap-6 text-sm font-medium text-orange-900/70">
          <a href="/breeds" className="hover:text-orange-600 transition-colors">Cat Breeds</a>
          <a href="/facts" className="hover:text-orange-600 transition-colors">Fun Facts</a>
        </div>
      </nav>
    </header>
  );
